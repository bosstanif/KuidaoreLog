...
<%@ page import="model.Restaurant,model.Reserve"%>


<%
Restaurant registerRes = (Restaurant) session.getAttribute("registerRes");
String errorMsg = (String) request.getAttribute("errorMsg");
Reserve reserveList = (Reserve) session.getAttribute("reserveList");
String resHoliday1 = (String) request.getAttribute("resHoliday1");
%>
<!DOCTYPE html>
<html lang="ja">
...
<div id="footer_wrapper">
	...
	<br>
	<a class="register_button" href="/kuidaoreLog/ResRegister" title="新規レストラン登録へ戻る">戻る</a>
	</div>
	...
	<br>
        ...
        <td class="contact-body">
		<b><%=registerRes.getResBusinessTime()%></b>
		<!-- このgetでは持ってくるフィールド変数の頭文字を大文字にする必要あり -->
        </td>
        </tr>
        ...
        <% if(resHoliday1==null){%>
        <%
        String[] strhol = reserveList.getResHoliday();
		for (String reserve : strhol) {
		%>
		<%=reserve%>
		<%}%>	<%}else{%>
		<%= resHoliday1%>
	...
	<h3>この内容で店舗登録してよろしいですか？</h3>
	<br><br>
	<a class="register_button margin_80px_right"  href="/kuidaoreLog/ResRegister?action=done" title="店舗登録する">はい</a>
	<!--⑰-->
	<a class="register_button"  href="/kuidaoreLog/ResRegister" title="新規店舗登録へ戻る">いいえ</a>
	</div>
	</div>
